...
namespace Kompas.Cards.Models
{
	...
	public class GameCardInfo : GameCardBase, IGameCardInfo
	{
		...
		public override IReadOnlyCollection<IGameCard> AdjacentCards { get; }
		...
		public IGameCard? AugmentedCard { get; protected set; }
		public IEnumerable<IGameCard> Augments { get; protected set; }
		...
		public static GameCardInfo? CardInfoOf(IGameCard? card)
		{
		...
		public GameCardInfo(IGameCard card)
			: base(CardStats.Of(card),
						card.SubtypeText, card.SpellSubtypes,
						card.Unique,
