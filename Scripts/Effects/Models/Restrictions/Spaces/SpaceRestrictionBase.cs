...
{
	public abstract class SpaceRestrictionBase : RestrictionBase<Space>, IRestriction<IGameCard>, IRestriction<TriggeringEventContext>, IRestriction<(Space s, Player p)>
	{
