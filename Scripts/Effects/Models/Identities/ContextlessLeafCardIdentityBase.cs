...
public abstract class ContextlessLeafCardIdentityBase : ContextlessLeafIdentityBase<IGameCardInfo>,
	IIdentity<Space>, IIdentity<IReadOnlyCollection<Space>>, IIdentity<IList<IGameCardInfo>>
{
	...
	IList<IGameCardInfo>? IIdentity<IList<IGameCardInfo>>.From(IResolutionContext context, IResolutionContext secondaryContext)
	{
		var item = Item;
		return item is null ? null : new IGameCardInfo[] { item };
    }
}